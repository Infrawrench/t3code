...
export const ServerSettings = Schema.Struct({
  ...
  // Reclaims disk from settled worktree threads by deleting regenerable
  // build artifacts (node_modules, Cargo target, framework caches).
  cleanWorktreeArtifactsOnSettle: Schema.Boolean.pipe(
    Schema.withDecodingDefault(Effect.succeed(false)),
  ),
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  cleanWorktreeArtifactsOnSettle: Schema.optionalKey(Schema.Boolean),
